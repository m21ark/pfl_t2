...
#### Board
 Board is represented by a 2d list in which 'O' is an empty space in the board. Using the following predicate, gen_2d_array, we are able to make our program modular and ready
```prolog
